...
const copy = {
  es: {
    heroTitle: "Calculadora de renta anual", heroAccent: "Contra lo que ya te retuvieron.",
  ...
  en: {
    heroTitle: "Annual tax calculator", heroAccent: "Against what was already withheld.",
